node() {
    ...
    stage('Import results to Xray') {
        ...
        def info = '''{
            ...
            step([$class: 'XrayImportBuilder', projectKey: projectId, endpointName: '/junit', importFilePath: 'reports/*.xml', importInfo: info, inputInfoSwitcher: 'fileContent', serverInstance: xrayConnectorId])
        }
    stage('cleanWs') {
        echo "\n\nCleanWs"
        cleanWs()
